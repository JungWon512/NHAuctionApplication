...
import com.nh.auction.ControllerApplication;
import com.nh.auction.controller.AuctionMessageController;
import com.nh.auction.controller.SampleController;
...
public class MoveStageUtil {
	...
	public synchronized void moveSampleStage(Stage stage) {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(getFXMLResource("Sample.fxml"));
