...
public class BillboardDelegate1 {

    private final Logger mLogger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

    private static BillboardDelegate1 instance = null;

    private BillboardShareNettyClient mClient; // 네티 접속 객체

    public static synchronized BillboardDelegate1 getInstance() {
        if (instance == null) {
            instance = new BillboardDelegate1();
        }
        return instance;
    }
