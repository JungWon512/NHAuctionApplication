...
public class GlobalDefine {
	...
	public static final class APPLICATION_INFO {
		...
		public static final String RELEASE_VERION = "1.2.1"; // application 버전
		//public static final String RELEASE_VERION = "1.1.9"; // application 버전
		
		public static final String RELEASE_DATE = "2022-09-07"; // 업데이트 날짜 
