...
public class SharedPreference {
	...
	public static final String PREFERENCE_SETTING_UPPER_GOAT_TEXT = "PREFERENCE_SETTING_UPPER_GOAT_TEXT";
	public static final String PREFERENCE_SETTING_UPPER_HORSE_TEXT = "PREFERENCE_SETTING_UPPER_HORSE_TEXT";
	...
	public static final String PREFERENCE_SETTING_LOWER_GOAT_TEXT = "PREFERENCE_SETTING_LOWER_GOAT_TEXT";
	public static final String PREFERENCE_SETTING_LOWER_HORSE_TEXT = "PREFERENCE_SETTING_LOWER_HORSE_TEXT";
	// 경매 응찰 프로그램 환경설정 [END]
	...
	public static final String PREFERENCE_SETTING_USE_PENDING_AUTO_START1 = "PREFERENCE_SETTING_USE_PENDING_AUTO_START1";
	// 연속 ,음성 경매  [END]
