...
public class SpEntryInfo implements FromAuctionController {
	...
	public String getEncodedMessage() {
		return String.format(
				"%c%c%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c" + "%s%c"
						+ "%s%c" + "%s",
				ORIGIN, TYPE, AuctionShareSetting.DELIMITER, getAuctionHouseCode().getValue(), AuctionShareSetting.DELIMITER, getEntryNum().getValue(), AuctionShareSetting.DELIMITER, getEntryType().getValue(), AuctionShareSetting.DELIMITER, getIndNum().getValue(), AuctionShareSetting.DELIMITER,
				...
				AuctionShareSetting.DELIMITER, getBirthday().getValue(), AuctionShareSetting.DELIMITER, getKpn().getValue(), AuctionShareSetting.DELIMITER, getGender().getValue(), AuctionShareSetting.DELIMITER, getMotherTypeCode().getValue(), AuctionShareSetting.DELIMITER,
