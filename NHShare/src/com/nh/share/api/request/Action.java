...
public abstract class Action implements Runnable {
    ...
    Action() {
        ...
        if (mRetrofit == null) {
            mRetrofit = new Retrofit.Builder().baseUrl(GlobalDefine.getInstance().getBaseDomain()).addConverterFactory(GsonConverterFactory.create())
    ...
    public enum resultType {
        ACTION_RESULT_RUNNEXT, ACTION_RESULT_ERROR_DISABLE_NETWORK, ACTION_RESULT_ERROR_NOT_RESPONSE, ACTION_RESULT_ERROR_RESPONSE,
        ACTION_RESULT_ERROR_SKIP, ACTION_RESULT_ERROR_INTRO
    }
    ...
    private class ApplicationInterceptor implements Interceptor {
        ...
        public Response intercept(Interceptor.Chain chain) throws IOException {
            ...
            Request request = original.newBuilder().header(REQUEST_ACCEPT, ACCEPT_CONTENT_TYPE).header(USER_AGENT, USER_AGENT_OS)
