...
public class ActionFileDownload extends Action {
     ...
     *            파일 다운로드 후 리스너
     */
    public ActionFileDownload(String url, String filePath, String fileName, ActionResultListener resultListener, FileDownLoadListener fileDownLoadListener, String name) {
        mUrl = url;
        mFilePath = filePath;
        mFileName = fileName;
        mName = "DOWNLOAD " + name;

        mContentType = "application/x-msdownload;charset=UTF-8";
