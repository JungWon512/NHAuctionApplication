...
/**
 * 부재자 입찰 정보 조회 요청 API명 : getAbsenteeAuctionBidInfo 부재자 입찰 정보를 조회한다.
 *
 */
public class ActionRequestAbsenteeAuctionBidInfo extends Action {
    private final Logger mLogger = LoggerFactory.getLogger(ActionRequestAbsenteeAuctionBidInfo.class);
     ...
     */
    public ActionRequestAbsenteeAuctionBidInfo(String auctionCode, String auctionRound, String auctionLaneCode,
    ...
    public interface RetrofitAPIService {
        @GET(GlobalDefine.API_GET_ABSENTEE_AUCTION_BID_INFO)
        Call<ResponseAbsenteeAuctionBidInfo> getAbsenteeAuctionBidInfo(@Query("auctionCode") String auctionCode,
    ...
    private final Callback<ResponseAbsenteeAuctionBidInfo> mCallBack = new Callback<ResponseAbsenteeAuctionBidInfo>() {
        @Override
        public void onResponse(Call<ResponseAbsenteeAuctionBidInfo> call,
                Response<ResponseAbsenteeAuctionBidInfo> response) {
            actionDone(resultType.ACTION_RESULT_RUNNEXT);
            Headers headers = response.headers();
            String type = headers.get(CONTENT_TYPE);
            ResponseAbsenteeAuctionBidInfo body = response.body();
        ...
        @Override
        public void onFailure(Call<ResponseAbsenteeAuctionBidInfo> call, Throwable t) {
    ...
    public void run() {
        ...
        mLogger.debug("================RequestAbsenteeAuctionBidInfo[Start]================");
        ...
        mLogger.debug("================RequestAbsenteeAuctionBidInfo[ End ]================");

        RetrofitAPIService mRetrofitAPIService = mRetrofit.create(RetrofitAPIService.class);
        mRetrofitAPIService
                .getAbsenteeAuctionBidInfo(mAuctionCode, mAuctionRound, mAuctionLaneCode, mAuctionEntryNumSeq)
                .enqueue(mCallBack);
    }
}
