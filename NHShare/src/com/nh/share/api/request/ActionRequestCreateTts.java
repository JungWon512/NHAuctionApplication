 ...
 *
 */
public class ActionRequestCreateTts extends Action {
     ...
     * @param mAuctionEntryNum 경매 서버 생성 결과
     * @param resultListener
     */
    public ActionRequestCreateTts(String auctionCode, String auctionRound, String auctionLaneCode,
    ...
    public interface RetrofitAPIService {
        @FormUrlEncoded
        @POST(GlobalDefine.API_REQUEST_CREATE_TTS)
        Call<ResponseCreateTtsResult> updateAuctionServerResult(@FieldMap RequestBody body);
    }

    private final Callback<ResponseCreateTtsResult> mCallBack = new Callback<ResponseCreateTtsResult>() {
        @Override
        public void onResponse(Call<ResponseCreateTtsResult> call, Response<ResponseCreateTtsResult> response) {
            actionDone(resultType.ACTION_RESULT_RUNNEXT);
            Headers headers = response.headers();
            String type = headers.get(CONTENT_TYPE);
            ResponseCreateTtsResult body = response.body();
        ...
        @Override
        public void onFailure(Call<ResponseCreateTtsResult> call, Throwable t) {
    ...
    public void run() {
        ...
        body.put("auctionEntryNum", mAuctionEntryNum);
