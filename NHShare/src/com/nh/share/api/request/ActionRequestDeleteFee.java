 ...
 * @author jhlee
 */
public class ActionRequestDeleteFee extends Action {
	
	private RequestFeeBody mBody = null;
	
	public ActionRequestDeleteFee(RequestFeeBody body, ActionResultListener<ResponseNumber> resultListener) {
		this.mBody = body;
	...
	public interface RetrofitAPIService {
		...
		@FormUrlEncoded
		@POST(NetworkDefine.API_REQUEST_AUCTION_DELETE_FEE)
		Call<ResponseNumber> requestDeleteFee(
	...
	public void run() {
		...
		mRetrofitAPIService.requestDeleteFee(NetworkDefine.API_VERSION,mBody).enqueue(mCallBack);
	}
}
