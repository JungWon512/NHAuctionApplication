 ...
 * @author jhlee
 */
public class ActionRequestInsertBidLog extends Action {
	private static final Logger mLogger = LoggerFactory.getLogger(ActionRequestInsertBidLog.class);
	private RequestBidLogBody mBody = null;
	
	public ActionRequestInsertBidLog(RequestBidLogBody body, ActionResultListener<ResponseNumber> resultListener) {
		this.mBody = body;
	...
	public interface RetrofitAPIService {
		...
		@FormUrlEncoded
		@POST(NetworkDefine.API_REQUEST_AUCTION_BID_LOG)
		Call<ResponseNumber> requestInsertBidLog(
	...
	public void run() {
		...
		mRetrofitAPIService.requestInsertBidLog(NetworkDefine.API_VERSION,mBody).enqueue(mCallBack);
	}
}
