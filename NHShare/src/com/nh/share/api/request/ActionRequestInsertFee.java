 ...
 * @author jhlee
 */
public class ActionRequestInsertFee extends Action {
	
	private String mBody = null;
	
	public ActionRequestInsertFee(String params, ActionResultListener<ResponseNumber> resultListener) {
		this.mBody = params;
	...
	public interface RetrofitAPIService {
		...
		@FormUrlEncoded
		@POST(NetworkDefine.API_REQUEST_AUCTION_INSERT_FEE)
		Call<ResponseNumber> requestInsertFee(
	...
	public void run() {
		...
		mRetrofitAPIService.requestInsertFee(NetworkDefine.API_VERSION,mBody).enqueue(mCallBack);
	}
}
