 ...
 * @author jhlee
 */
public class ActionRequestSelectBidLogCnt extends Action {
	
	private RequestBidLogBody mBody = null;
	
	public ActionRequestSelectBidLogCnt(RequestBidLogBody body, ActionResultListener<ResponseNumber> resultListener) {
		this.mBody = body;
	...
	public interface RetrofitAPIService {
		...
		@FormUrlEncoded
		@POST(NetworkDefine.API_REQUEST_AUCTION_BID_LOG_CNT)
		Call<ResponseNumber> requestSelecBidLogCnt(
	...
	public void run() {
		...
		mRetrofitAPIService.requestSelecBidLogCnt(NetworkDefine.API_VERSION,mBody).enqueue(mCallBack);
	}
}
