 ...
 * @author jhlee
 */
public class ActionRequestSelectMacoYn extends Action {
	
	private RequestMacoYnBody mBody = null;
	
	public ActionRequestSelectMacoYn(RequestMacoYnBody body, ActionResultListener<ResponseMacoYn> resultListener) {
		this.mBody = body;
	...
	public interface RetrofitAPIService {
		...
		Call<ResponseMacoYn> requestSelecNextBid(
				@Path("version") String apiVer,
				@FieldMap HashMap<String, Object> paramBody);
	}

	private final Callback<ResponseMacoYn> mCallBack = new Callback<ResponseMacoYn>() {
		@Override
		public void onResponse(Call<ResponseMacoYn> call, Response<ResponseMacoYn> response) {
			actionDone(resultType.ACTION_RESULT_RUNNEXT);
			Headers headers = response.headers();
			String type = headers.get(CONTENT_TYPE);
			ResponseMacoYn body = response.body();
		...
		@Override
		public void onFailure(Call<ResponseMacoYn> call, Throwable t) {
