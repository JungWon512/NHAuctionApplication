 ...
 * @author jhlee
 */
public class ActionRequestUpdateCowResult extends Action {
	
	private String mBody = null;
	
	public ActionRequestUpdateCowResult(String param, ActionResultListener<ResponseNumber> resultListener) {
		this.mBody = param;
	...
	public interface RetrofitAPIService {
		...
		@FormUrlEncoded
		@POST(NetworkDefine.API_REQUEST_AUCTION_UPDATE_COW_RESULT)
		Call<ResponseNumber> requestUpdateCowResult(
	...
	public void run() {
		...
		mRetrofitAPIService.requestUpdateCowResult(NetworkDefine.API_VERSION,mBody).enqueue(mCallBack);
	}
}
